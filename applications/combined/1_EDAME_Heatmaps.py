...
for edge_p in p_edges:
    for edge_n in n_edges:
        ...
        #################################################### Dataframe
        main_df = healthy_main_df.merge(CRC_main_df, on=['Species1', 'Species2'], how = 'outer').merge(IBD_main_df, on=['Species1', 'Species2'], how = 'outer')
        ...
        #################################################### Figure
        sns.heatmap(JI_df, cmap = 'RdYlBu', linewidths=0.5, annot=False) #PiYG
